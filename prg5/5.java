...
mediaPlayer= MediaPlayer.create(this, R.raw.song); mediaPlayernew= MediaPlayer.create(this, R.raw.song); TextView songtitle=findViewById(R.id.textView2); 
...
@Override 
public void onClick(View v) { 
int curtops-media Player.getCurrentPosition(); if((curtops-backwardtime)>=0) { 
