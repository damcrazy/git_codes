...
class Questions {
  List<Question> questionBank = [
    // create a list of Questions using default
    Question(
        questionText: "Rainbow has 10 colours",
        answer: false), // set the Question and Answer
    Question(questionText: " Director of RRR is Rajamouli ", answer: true),
    Question(questionText: " Black box in plane is black ", answer: true),
    Question(questionText: " Mango is a fruit ", answer: true),
